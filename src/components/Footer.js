...
const Footer = () => {
  return (
    ...
    <div className="mx-6 py-4 text-center md:text-left">
        <div className="grid justify-center grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-8">
        <div className="ml-44">
            ...
            <p>
            Organise All yours notes at one place and access it from anywhere.
            </p>
        </div>
        <div className="ml-44">
